#!/usr/bin/python2
# coding=utf-8
# code by JONI GANTENG-GANTENG

#      (C) Copyright 407 Authentic Exploit
#      Rebuild Copyright Can't make u real programmer:)
#      Coded By JONI GANTENG
...
logo = ''' \033[0;96m __  __        __  ______  ____
 \033[0;96m   / _ )/ __/ ® \033[0m|| Created By JONI GANTENG
 \033[0;96m ___/ / /|_/ / _  / _/     \033[0m|| Github.com/JONI GANTENG
...
def yayanxd():
    ...
    try:
        ...
        print '\n\n %s*%s selamat datang anjing %s%s%s'%(O,N,K,nama,N);time.sleep(2)
        print ' %s*%s mohon untuk menggunakan sc ini sewajarnya, klo berlebihan kamu goblok tidak bertanggung jawab jika sc ini disalah gunakan...'%(O,N);time.sleep(2)
